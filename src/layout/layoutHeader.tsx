export default function LayoutHeader() {
    return (
        <header
            class="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-[48] w-full bg-white border-b text-sm py-2.5 lg:ps-[260px] dark:bg-neutral-800 dark:border-neutral-700" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-application-sidebar" aria-label="Toggle navigation" data-hs-overlay="#hs-application-sidebar">
            <nav class="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
                ...
                <div class="w-full flex items-center ms-auto gap-x-1 md:gap-x-3 justify-end">
